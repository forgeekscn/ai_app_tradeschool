...
### 1. 创意构思
**用 [AI-product-development-tools](https://github.com/TechNomadCode/AI-Product-Development-Toolkit) 模板工程生成产品** :将idea填入prd模板，如"我想开发一个校园交流交易平台，功能大概有活动发布和二手交易功能" 如 [prd需求](prd需求.md)  (备注：需避免过度设计)

### 2. UI设计
**带着详细需求去 [gemDesign](https://design.gemcoder.com/)设计UI 文档**: 如 [gemDesign原型导出](gemDesign原型导出.html) （备注: 一次生成好别乱改）

### 3. 前端项目开发
**带着导出的html去[Claude-Code-Cli](https://yuanbao.tencent.com/extra/video-play?id=PoLNnxzc&agentId=&cid=e1289c80-811d-49ed-9fc6-4192bdbb3db6&traceId=d82c88b2e685a44335707b8a9348bd2c&modelId=hunyuan_t1&index=0&pos=bottom_video&exportId=export/UzFfAgtgekIEAQAAAAAA2Xol_pys1wAAAAstQy6ubaLX4KHWvLEZgBPE4aBEYCh5FMCOzNPgMFkNA7cjx0dmTuWYTwDCOjddUg&isChatting=0) + [GLM-4.6](https://www.bigmodel.cn/claude-code?ic=ADUBDKVZOF) 生成前端代码**: "prompt: 根据导出html生成前端代码，需要保证功能完整，允许构造数据" 

### 4. 前端功能完善
**检查并完善**: "prompt：完善首页tab、二手交易tab、兴趣小组tab、内容社区tab、我的tab，页面风格统一简约友好，需要保证功能完整，允许构造数据"  如我第一次导入发现问题 [交互逻辑缺失清单](交互逻辑缺失清单.md)   [素材缺失问题解决](素材.md)
...
#### iOS/Android应用
 **AI提示词**: "prompt:使用Capacitor将React Web应用转换为iOS和Android原生应用，包含完整的配置和打包流程" 随后在android studio或xcode打开编译运行, 如 [nextjs转ios方案](转换ios.md)（备注：Capacitor适合交互不多快速转换的普通项目，Solito适合交互复杂项目，taro适合转小程序） 
